...
impl<O: OutputWriter> GeneralCommandOutputManager<O> {
    ...
    pub fn show_help(&mut self) {
        ...
        self.output_writer.borrow_mut().write_line("");
        self.output_writer.borrow_mut().write_line(&MessageFormatter::command("remove <id|range|all>", "Remove task(s)"));
        self.output_writer.borrow_mut().write_line(&MessageFormatter::subinfo("Examples:", "1, 1-5, 1,3,5, all"));
        self.output_writer.borrow_mut().write_line(&MessageFormatter::label("Aliases:", "rm, delete"));
        self.output_writer.borrow_mut().write_line("");
        self.output_writer.borrow_mut().write_line(&MessageFormatter::command("complete <id|range|all>", "Mark task(s) as completed"));
        self.output_writer.borrow_mut().write_line(&MessageFormatter::subinfo("Examples:", "1, 1-5, 1,3,5, all"));
        self.output_writer.borrow_mut().write_line(&MessageFormatter::label("Alias:", "done"));
        self.output_writer.borrow_mut().write_line("");
        self.output_writer.borrow_mut().write_line(&MessageFormatter::command("uncomplete <id|range|all>", "Mark task(s) as pending"));
        self.output_writer.borrow_mut().write_line(&MessageFormatter::subinfo("Examples:", "1, 1-5, 1,3,5, all"));
        self.output_writer.borrow_mut().write_line(&MessageFormatter::label("Alias:", "undo"));
        self.output_writer.borrow_mut().write_line("");
        self.output_writer.borrow_mut().write_line(&MessageFormatter::command("toggle <id|range|all>", "Toggle task(s) completion status"));
        self.output_writer.borrow_mut().write_line(&MessageFormatter::subinfo("Examples:", "1, 1-5, 1,3,5, all"));
        self.output_writer.borrow_mut().write_line("");
        self.output_writer.borrow_mut().write_line(&MessageFormatter::command("priority <id|range|all> <level>", "Set task(s) priority"));
        self.output_writer.borrow_mut().write_line(&MessageFormatter::subinfo("Examples:", "1 high, 1-5 low, all medium"));
        ...
        self.output_writer.borrow_mut().write_line("");
        self.output_writer.borrow_mut().write_line(&MessageFormatter::command("set-category <id|range|all> <name>", "Set task(s) category"));
        self.output_writer.borrow_mut().write_line(&MessageFormatter::subinfo("Examples:", "1 work, 1-5 personal, all none"));
        ...
        self.output_writer.borrow_mut().write_line("");
        self.output_writer.borrow_mut().write_line(&MessageFormatter::command("new-project <name>", "Create a new project"));
        self.output_writer.borrow_mut().write_line(&MessageFormatter::label("Aliases:", "new-proj, create-project"));
        self.output_writer.borrow_mut().write_line("");
        self.output_writer.borrow_mut().write_line(&MessageFormatter::command("switch-project <name>", "Switch to a different project"));
        self.output_writer.borrow_mut().write_line(&MessageFormatter::label("Aliases:", "switch, switch-to, use-project"));
        self.output_writer.borrow_mut().write_line("");
        self.output_writer.borrow_mut().write_line(&MessageFormatter::command("list-projects", "List all projects"));
        self.output_writer.borrow_mut().write_line(&MessageFormatter::label("Aliases:", "projects, show-projects"));
        self.output_writer.borrow_mut().write_line("");
        self.output_writer.borrow_mut().write_line(&MessageFormatter::command("delete-project <name>", "Delete a project"));
        self.output_writer.borrow_mut().write_line(&MessageFormatter::label("Aliases:", "rm-project, remove-project"));
        self.output_writer.borrow_mut().write_line("");
        self.output_writer.borrow_mut().write_line(&MessageFormatter::command("rename-project <old_name> <new_name>", "Rename a project"));
        self.output_writer.borrow_mut().write_line(&MessageFormatter::label("Aliases:", "mv-project, move-project"));
        self.output_writer.borrow_mut().write_line("");
